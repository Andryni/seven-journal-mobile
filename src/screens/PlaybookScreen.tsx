...
const createStyles = (theme: AppTheme) => StyleSheet.create({
  ...
  filterPill: { paddingHorizontal: 12, paddingVertical: 7, minHeight: 30, justifyContent: 'center', alignItems: 'center', borderRadius: 20, backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.cardBorder },
  filterPillActive: { backgroundColor: 'rgba(99, 102, 241, 0.2)', borderColor: theme.colors.primary },
  filterPillText: { color: theme.colors.textMuted, fontSize: 11, fontFamily: theme.fonts.sansSemiBold, includeFontPadding: false },
